...
# accuracy = np.array([
#     48579.88, 46558.40, 60227.96,
#     48579.88, 46334.46, 53705.26,
#     48342.41, 46011.74, 52773.60,
#     48342.41, 46011.74, 53394.71
# ])
accuracy = np.array([
    45506.46, 52655.95, 51933.67,
    45217.96, 50336.858, 51697.81,
    45217.96, 50048.3, 51461.94,
    40279.45, 48686.81, 51226.07
])
...
# **反转 x 和 y 轴方向**
ax.set_xlim(ax.get_xlim())  # 反转 x 轴 (Diameter)
ax.set_ylim(ax.get_ylim())  # 反转 y 轴 (non-IID Degree)
