...
- [docs/review_classification.md](docs/review_classification.md) — 审稿意见分类标记（按6个工作量维度：实验/图表/正文/理论/讨论/小修）
- [docs/experiment_revision_order.md](docs/experiment_revision_order.md) — 实验修订顺序（6步，含依赖关系、详情、预估时间线）
- [docs/progress.md](docs/progress.md) — 项目进度记录

## 主脚本

- [onlineFL_step1_全参数固定的仿真模板代码_用于获取每一time的实际训练量_FINAL.py](onlineFL_step1_全参数固定的仿真模板代码_用于获取每一time的实际训练量_FINAL.py) — Step 1: 全参数固定仿真，获取每time实际训练量
