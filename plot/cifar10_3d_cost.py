...
#80%的成本数据
accuracy = np.array([
    712726, 2000467, 2684514,
    581398, 1860275, 2287014,
    548566, 1755131, 2121389,
    499318, 1614939, 2154514
])
# #85%的成本数据
# accuracy = np.array([
#     53803, 122973, 136117,
...
ax.set_zlim(0, 2900000)  # 手动设置 Z 轴显示范围
# ax.set_zlim(accuracy.min()-300000, accuracy.max()+1)  # 手动设置 Z 轴显示范围
...
save_path = os.path.join(save_dir, f'3d_cost_{current_time}.pdf')
