...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        # 如果维度不匹配或步长不为1，需要用 1x1 卷积调整 shortcut 的维度
...
class ResNet18Cifar(nn.Module):
    def __init__(self, args=None, num_classes=100):
        ...
        # 兼容你的代码风格，允许从 args 提取分类数，默认 100
        classes = args.num_classes if (args and hasattr(args, 'num_classes')) else num_classes
        
        self.in_planes = 64

        # 完美适配 CIFAR-100 的关键修改 1: 3x3 卷积，stride 1，padding 1
        self.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(64)
        
        # 完美适配 CIFAR-100 的关键修改 2: 移除了这里的 MaxPool2d
        ...
        # 完美适配 CIFAR-100 的关键修改 3: 分类器映射到 100 类
        self.linear = nn.Linear(512 * BasicBlock.expansion, classes)
    ...
    def forward(self, x):
        ...
        # 经过 4 个 layer 后，32x32 的特征图变为了 4x4 大小
        # 因此使用 kernel_size=4 的 AvgPool2d 将其全局池化为 1x1
